...
export default {
    ...
    data () {
        return {
            ...
            importResultMsg: '',
            importResultPath: '',
            tplUrl: process.env.VUE_APP_API_PREFIX + '/ba/sku/downloadExcelTemplate?' + qs.stringify({
    ...
    methods: {
        ...
        handleUpload (opts) {
            ...
            api.base.batchImport(data).then(({ head, body }) => {
                if (head.code === '200' && body) {
                    ...
                    this.importResultPath = process.env.VUE_APP_API_PREFIX + '/ba/sku/downloadExcel?' + qs.stringify(params)
                }
                this.queryList()
