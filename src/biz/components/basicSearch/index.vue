...
export default {
    ...
    methods: {
        calcStatus () {
            ...
            console.log('ssssssssssss',formH)
            if (formH > 88.5 ) {
                this.showMore = true
            } else {
                this.showMore = false
...
// 重新处理 时间选择器的 样式
.basic-search /deep/ .el-range-editor {
...
@media screen and (min-width:1366px) and (max-width:1608px) {
    .basic-search__col-l {
        /deep/ .el-form-item {
            width: 33%;
        }
...
@media screen and (min-width:1608px) and (max-width:1920px) {
    .basic-search__col-l {
        /deep/ .el-form-item {
            width: 25%;
        }
