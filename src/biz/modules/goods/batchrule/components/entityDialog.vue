            ...
            <el-table
                ...
                width="220">
                    <template slot-scope="scope">
                            <el-input @input="scope.row.Validate = false" :disabled="scope.row.batachLetter=='生产日期'||scope.row.batachLetter=='失效日期'||scope.row.batachLetter=='入库日期'||scope.row.batachLetter=='生产批次'" v-model="scope.row.batachLetter" />
                    </template>
                </el-table-column>
                <el-table-column
...
export default {
    ...
    beforeCreate () {
        this.allFields = [ 'id', 'code', 'name', 'remark','lotatt01Name','lotatt01Validate', 'lotatt01Type',{ key: 'lotatt02Name', default:'失效日期' } ,'lotatt02Validate', 'lotatt02Type',{ key: 'lotatt03Name', default:'生产批次' } ,'lotatt03Validate', 'lotatt03Type',{ key: 'lotatt04Name', default:'入库日期' } ,'lotatt04Validate', 'lotatt04Type','lotatt05Name' ,'lotatt05Validate', 'lotatt05Type','lotatt06Name' ,'lotatt06Validate', 'lotatt06Type'
    ...
    watch:{
        'dto' (val){
            ...
            {
                    batachLetter: '生产日期',
                    Validate: this.dto.lotatt01Validate || false,
                    Type: 10
                },
                {
                    batachLetter: '失效日期',
                    Validate: this.dto.lotatt02Validate || false,
                    Type: 10
                },
                {
                    batachLetter: '生产批次',
                    Validate: this.dto.lotatt03Validate || false,
                    Type: 30
                },
                {
                    batachLetter: '入库日期',
                    Validate: this.dto.lotatt04Validate || false,
                    Type: 10
                },
                {
                    batachLetter: this.dto.lotatt05Name||'批次属性5',
                    Validate: this.dto.lotatt05Validate,
                    Type:  this.dto.lotatt05Type
                },
                {
                    batachLetter: this.dto.lotatt06Name||'批次属性6',
                    Validate: this.dto.lotatt06Validate,
                    Type: this.dto.lotatt06Type
                },
                {
                    batachLetter: this.dto.lotatt07Name||'批次属性7',
                    Validate: this.dto.lotatt07Validate,
                    Type: this.dto.lotatt07Type
                },
                {
                    batachLetter: this.dto.lotatt08Name||'批次属性8',
                    Validate: this.dto.lotatt08Validate,
                    Type: this.dto.lotatt08Type
                },
                {
                    batachLetter: this.dto.lotatt09Name||'批次属性9',
                    Validate: this.dto.lotatt09Validate,
                    Type: this.dto.lotatt09Type
                },
                {
                    batachLetter: this.dto.lotatt10Name||'批次属性10',
