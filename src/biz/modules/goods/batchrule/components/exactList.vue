<template>
    <basic-list
        ...
        <template slot="hd-col--l">
            ...
            <el-button v-if="rcMap['ba.sku.lotrule.add']" type="primary" size="mini" @click="handleAdd" >新建</el-button>
            <el-button v-if="rcMap['ba.sku.lotrule.modify']" type="primary" size="mini" @click="onEdit">修改</el-button>
            <el-button v-if="rcMap['ba.sku.lotrule.enable']" type="primary" size="mini" @click="onStart" >启用</el-button>
            <el-button v-if="rcMap['ba.sku.lotrule.stop']" type="primary" size="mini" @click="onStop" >停用</el-button>
        </template>
    </basic-list>
</template>
