...
export default {
    ...
    methods: {
        ...
        handleExport(){
            ...
            return download({
                url: process.env.VUE_APP_API_PREFIX+'/ba/carrier/exportExcel',
                data: query
            });
        },
        // 编辑按钮响应事件
        ...
        handleStart (logisticIds) {
            this.dispatch('start', { params: logisticIds , cb: this.queryList }) 
        },
        handleStop (carrierIds) {
            this.dispatch('stop', { params: carrierIds , cb: this.queryList })
        }
    }
}
</script>
