...
export default {
    ...
    data () {
        return {
            ...
            importResultMsg: '',
            importResultPath: '',
            tplUrl: process.env.VUE_APP_API_PREFIX + '/wi/asn/import/downloadExcelTemplate?' + qs.stringify({
    ...
    methods: {
        ...
        handleUpload (opts) {
            ...
            api.stock.importEl(data).then(({ head, body }) => {
                if (head.code === '200' && body) {
                    ...
                    this.importResultPath = process.env.VUE_APP_API_PREFIX + '/wi/asn/import/downloadErrorExcel?' + qs.stringify(params)
                }
