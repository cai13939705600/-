                ...
                <el-row :gutter="24">
                    ...
                    <el-col :span="8">
                        <el-form-item label="供应商">
                            <el-input v-model="tableHeaderDate.supplier.name" :disabled="true"/>
                        </el-form-item>
                    </el-col>
                </el-row>
            </div>
                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            >
                                <el-input v-model="scope.row.receivedQty" @input="changeQty(scope.row)"/>
                            </el-form-item>
                        </template>
                    </el-table-column>
                    <el-table-column
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-form-item label="" label-width="0" 
                            >
                                <el-input :disabled="true" v-model="scope.row.amount"/>
                            </el-form-item>
                        </template>
                    </el-table-column>
                    <el-table-column
...
export default {
    ...
    computed: {
        ...mapState('stock/inStock', ['projectList'])
    },
    data () {
        return {
        //缓存收货弹窗选择列表
    ...
    methods: {
        ...
        changeQty(val){
            if(val.receivedQty>val.waitReceivedQty){
                val.receivedQty = val.waitReceivedQty
            }
            val.amount = val.price*val.receivedQty
        },
        handleOk () {
