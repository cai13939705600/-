...
export default {
    ...
    data () {
        return {
            ...
            importResultMsg: '',
            importResultPath: '',
            tplUrl: process.env.VUE_APP_API_PREFIX + '/ba/rest/api/location/import/downloadExcelTemplate?' + qs.stringify({
    ...
    methods: {
        ...
        handleUpload (opts) {
            ...
            api.library.importLocation(data).then(({ head, body }) => {
                if (head.code === '200' && body) {
                    ...
                    this.importResultPath = process.env.VUE_APP_API_PREFIX + '/ba/rest/api/location/import/downloadErrorExcel?' + qs.stringify(params)
                }
